...
% b is the numerator = 1/4(z^-1 + z^-2 + z^-3)
% <-- Answer: What is the denominator of this filter's transfer function?
% a is the denominator = z^-1 - z^-2 + 0.5z^-3 + 0.25z^-4
...
x1 = zeros(N,1); 
x1(1) = 1;
% <-- Answer: (True or False) x1 is an impulse excitation? If false,
% describe the excitation.
% 

% INPUT 2
x2 = zeros(N,1); 
x2(1:12)  = cos(3*pi/2*   n(1:12));
x2(13:24) = cos(pi/4*   n(13:24));
x2(25:36) = cos(2*pi*   n(25:36));
x2(37:48) = cos(3*pi/4* n(37:48));
x2(49:60) = cos(pi*     n(49:60));
x2(61:72) = cos(pi/8* n(61:72));
x2(73:84) = cos(pi/2*   n(73:84));
% <-- Answer: (True or False) x2 is an single frequency excitation? If 
% false, describe the excitation.
% 
